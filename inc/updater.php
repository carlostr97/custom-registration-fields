...
if (is_admin()) { //nota l'uso si is_admin(), serve per rassicurarci che ci troviamo nel backend
  $config = array(
    ...
    'proper_folder_name' => 'plugin-name', // il nome della cartella che contiene il nostro plugin
    'api_url' => 'http://api.github.com/repos/nomeutente/nome-repository', // la GitHub API url del repository contenente il plugin
    'raw_url' => 'http://raw.github.com/nomeutente/nome-repository/master', // la GitHub raw url del repository contenente il plugin
    'github_url' => 'http://github.com/nomeutente/nome-repository', // la GitHub url del repository contenente il plugin
    'zip_url' => 'http://github.com/nomeutente/nome-repository/zipball/master', // dove si trova l'archivio .zip del repository
